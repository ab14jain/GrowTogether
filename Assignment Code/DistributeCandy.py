#https://www.scaler.com/academy/mentee-dashboard/class/325360/assignment/problems/3?navref=cl_tt_nv
...
class Solution:
	...
	def candy(self, A):
            ...
            #             candies.append(max(A[i-1],A[i+1])+1)
            #         else:
